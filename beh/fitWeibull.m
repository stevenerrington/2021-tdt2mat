...
[bestFitParams minDiscrepancyFn exitflag output] = SEF_Toolbox_fminsearchbnd(@(param) Weibull_error(xData, yData, param),param,lower_bounds,upper_bounds,options);

...
session = 'Cmand1DR_Ephys-210314-094500';
sessionAnalysisDir = fullfile(dirs.processDataStore,session);


ops.dataDir             = fullfile(dirs.rawDataStore,session);   
ops.datatype            = 'tdt2Bin';  % This code is taking .sev data and will convert it to .bin/.dat
...
%% Get channel map
chanMapFile = 'C:\Users\Steven\Desktop\2021-tdt2mat-main\kilosort\Kilosort-2.5\configFiles\Neuronexus_150.mat';
...
%% Kilosort Directives
ops.verbose             = 1; % Output to console
...
[spikes] = phy2mat(ops); % :CHECK UNIT REFERENCING IN LOOP.

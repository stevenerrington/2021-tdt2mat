...
dataPath = 'C:\Users\Steven\Desktop\Data\Raw';
analysisDir = 'C:\Users\Steven\Desktop\Data\Raw';
session = 'Cmand1DR_Ephys-201021-100007';
chanMapFile = 'C:\Users\Steven\Desktop\Data\linear-probes-1-32-chan-150mu.mat';
sessionAnalysisDir = fullfile(analysisDir,session);
nChan = 32;


%% Params and configuration for Kilosort2
ks2Paths = genpath('C:\toolbox\Kilosort2\Kilosort2-master');
addpath(ks2Paths);
npyPths = genpath('C:\toolbox\Kilosort2\Kilosort2-master\npy-matlab-master');
addpath(npyPths);
